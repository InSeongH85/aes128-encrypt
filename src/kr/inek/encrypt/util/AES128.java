...
public class AES128 {
  private static final String KEY = "INEK_ENCRYPT$2#!";
  public static String encKey() {
    String encKey = "";
    try {
      String hexEncKey = HexEncoder.encode(KEY);
      encKey = Base64Encoder.encode(hexEncKey.getBytes("UTF-8"));
  ...
  public static String encrypt(String msg) throws Exception {
    ...
    // 70000번 해시하여 128 bit 길이의 키를 만든다.
  ...
  public static String decrypt(String msg) throws Exception {
    String key = encKey();
    Cipher cipher = Cipher.getInstance("AES/CBC/PKCS5Padding");
    ByteBuffer buffer = ByteBuffer.wrap(Base64Encoder.decode(msg));
